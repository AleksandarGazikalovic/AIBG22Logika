...
public class GameParameters {
    public static final int STARTING_HEALTH = 1000;
    public static final int STARTING_POWER = 150; //menjati

    public static final int RANGE = 3;
    public static final int MOVE_RANGE = 1;

    public static final int EXP_ON_KILL = 100;//menjati
    public static final int EXP_ON_HIT = 30;//menjati
    public static final int EXP_GATHER = 100; //menjati u sve tri zone
    public static final int EXP_ASTEROID = 20; //menjati
